...
always @ (posedge clk) begin
    if ((grp_RosenbrockSimulator_simulateRosenbrock_fu_88_fitness_ap_vld == 1'b1)) begin
        fitness <= grp_RosenbrockSimulator_simulateRosenbrock_fu_88_fitness;
    end
end

always @ (posedge clk) begin
    if ((grp_RosenbrockSimulator_simulateRosenbrock_fu_88_simulationDone_ap_vld == 1'b1)) begin
        simulationDone <= grp_RosenbrockSimulator_simulateRosenbrock_fu_88_simulationDone;
    end
end
