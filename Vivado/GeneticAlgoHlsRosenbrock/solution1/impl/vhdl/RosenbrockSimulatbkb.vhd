...
entity RosenbrockSimulatbkb_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of RosenbrockSimulatbkb_rom is 
...
entity RosenbrockSimulatbkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of RosenbrockSimulatbkb is
    component RosenbrockSimulatbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    RosenbrockSimulatbkb_rom_U :  component RosenbrockSimulatbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
