...
entity RosenbrockSimulatdEe_rom is 
    generic(
             DWIDTH     : integer := 105; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of RosenbrockSimulatdEe_rom is 
...
entity RosenbrockSimulatdEe is
    generic (
...
architecture arch of RosenbrockSimulatdEe is
    component RosenbrockSimulatdEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    RosenbrockSimulatdEe_rom_U :  component RosenbrockSimulatdEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
