...
// ==============================================================
#ifndef __RosenbrockSimulatdEe_H__
#define __RosenbrockSimulatdEe_H__
...
struct RosenbrockSimulatdEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(RosenbrockSimulatdEe_ram) {
...
SC_MODULE(RosenbrockSimulatdEe) {
...
RosenbrockSimulatdEe_ram* meminst;


SC_CTOR(RosenbrockSimulatdEe) {
meminst = new RosenbrockSimulatdEe_ram("RosenbrockSimulatdEe_ram");
