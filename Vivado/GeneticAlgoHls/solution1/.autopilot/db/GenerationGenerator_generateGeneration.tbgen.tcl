...
set C_modelArgList {
	...
	{ generation_parent1 int 64 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "startGenerating", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "GenerationGenerator.startGenerating.m_if.Val","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "generation_parent1", "interface" : "axi_slave", "bundle":"","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "GenerationGenerator.generation_parent1.m_if.Val.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
