...
set C_modelArgList {
	...
	{ GenerationGenerator_randomNumbers_V int 24 regular {array 160 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ generation_parent1 sc_in sc_lv 16 signal 2 } 
	{ generation_parent2 sc_in sc_lv 16 signal 3 } 
	{ generation_child1 sc_out sc_lv 16 signal 4 } 
	{ generation_child1_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ generation_child2 sc_out sc_lv 16 signal 5 } 
	...
	{ GenerationGenerator_randomNumbers_V_address1 sc_out sc_lv 8 signal 8 } 
	{ GenerationGenerator_randomNumbers_V_ce1 sc_out sc_logic 1 signal 8 } 
	{ GenerationGenerator_randomNumbers_V_q1 sc_in sc_lv 24 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "GenerationGenerator_randomNumbers_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "GenerationGenerator_randomNumbers_V", "role": "address1" }} , 
 	{ "name": "GenerationGenerator_randomNumbers_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "GenerationGenerator_randomNumbers_V", "role": "ce1" }} , 
 	{ "name": "GenerationGenerator_randomNumbers_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "GenerationGenerator_randomNumbers_V", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	generation_child1 { ap_vld {  { generation_child1 out_data 1 16 }  { generation_child1_ap_vld out_vld 1 1 } } }
	generation_child2 { ap_vld {  { generation_child2 out_data 1 16 }  { generation_child2_ap_vld out_vld 1 1 } } }
	...
	GenerationGenerator_randomNumbers_V { ap_memory {  { GenerationGenerator_randomNumbers_V_address0 mem_address 1 8 }  { GenerationGenerator_randomNumbers_V_ce0 mem_ce 1 1 }  { GenerationGenerator_randomNumbers_V_q0 mem_dout 0 24 }  { GenerationGenerator_randomNumbers_V_address1 mem_address 1 8 }  { GenerationGenerator_randomNumbers_V_ce1 mem_ce 1 1 }  { GenerationGenerator_randomNumbers_V_q1 mem_dout 0 24 } } }
}
