...
architecture behav of GenerationGenerator_produceRandom is 
    ...
    signal val_V_reg_153 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_CS_fsm : STD_LOGIC_VECTOR (2 downto 0) := "010";
    attribute fsm_encoding : string;
    attribute fsm_encoding of ap_CS_fsm : signal is "none";
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_fu_127_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_1_fu_132_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_fu_138_p2 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
    ...
    GenerationGenerator_randomNumberIndex_V_o <= 
        ap_const_lv24_0 when (tmp_1_fu_132_p2(0) = '1') else 
        tmp_2_fu_138_p2;
    ...
    GenerationGenerator_randomNumbers_V_address0 <= tmp_fu_127_p1(8 - 1 downto 0);
    ...
    GenerationGenerator_randomNumbers_V_d0 <= val_V_reg_153;
    ...
    tmp_1_fu_132_p2 <= "1" when (GenerationGenerator_randomNumberIndex_V_i = ap_const_lv24_17) else "0";
    tmp_2_fu_138_p2 <= std_logic_vector(unsigned(GenerationGenerator_randomNumberIndex_V_i) + unsigned(ap_const_lv24_1));
    tmp_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(GenerationGenerator_randomNumberIndex_V_i),32));
end behav;
