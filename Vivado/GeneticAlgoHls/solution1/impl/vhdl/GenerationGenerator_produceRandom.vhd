...
architecture behav of GenerationGenerator_produceRandom is 
    ...
    signal val_V_reg_164 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal tmp_2_fu_149_p2 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
    ...
    GenerationGenerator_randomNumberIndex_V_o <= 
        ap_const_lv24_0 when (tmp_1_fu_143_p2(0) = '1') else 
        tmp_2_fu_149_p2;
    ...
    GenerationGenerator_randomNumbers_V_address0 <= tmp_fu_138_p1(8 - 1 downto 0);
    ...
    GenerationGenerator_randomNumbers_V_d0 <= val_V_reg_164;
    ...
    tmp_1_fu_143_p2 <= "1" when (GenerationGenerator_randomNumberIndex_V_i = ap_const_lv24_17) else "0";
    tmp_2_fu_149_p2 <= std_logic_vector(unsigned(GenerationGenerator_randomNumberIndex_V_i) + unsigned(ap_const_lv24_1));
    tmp_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(GenerationGenerator_randomNumberIndex_V_i),64));
end behav;
