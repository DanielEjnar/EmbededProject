...
set Library     "hls"
set IPName      "GenerationGenerator"
set Version     "1.0"
set DisplayName "Generationgenerator"
set Revision    "1812201453"
...
## Variables
set Top "generationgenerator_top"
...
set Interfaces {
    S_AXI_SLV0 {
        ...
        addr_bits "7"
        module_info "addr_bits 7 include_register 1 reg_map {0 {name ADDR_AP_CTRL type ap_ctrl sigs {}} 4 {name ADDR_GIE type gie sigs {}} 8 {name ADDR_IER type ier sigs {}} 12 {name ADDR_ISR type isr sigs {}} 16 {name ADDR_STARTGENERATING_CTRL type i_none sigs startGenerating} 20 {name ADDR_STARTGENERATING_DATA_0 type i_data sigs {startGenerating[0:0]}} 24 {name ADDR_GENERATINGDONE_CTRL type o_none sigs generatingDone} 28 {name ADDR_GENERATINGDONE_DATA_0 type o_data sigs {generatingDone[0:0]}} 32 {name ADDR_GENERATION_PARENT1_CTRL type i_none sigs generation_parent1} 36 {name ADDR_GENERATION_PARENT1_DATA_0 type i_data sigs {generation_parent1[31:0]}} 40 {name ADDR_GENERATION_PARENT1_DATA_1 type i_data sigs {generation_parent1[63:32]}} 44 {name ADDR_GENERATION_PARENT2_CTRL type i_none sigs generation_parent2} 48 {name ADDR_GENERATION_PARENT2_DATA_0 type i_data sigs {generation_parent2[31:0]}} 52 {name ADDR_GENERATION_PARENT2_DATA_1 type i_data sigs {generation_parent2[63:32]}} 56 {name ADDR_GENERATION_CHILD1_CTRL type o_none sigs generation_child1} 60 {name ADDR_GENERATION_CHILD1_DATA_0 type o_data sigs {generation_child1[31:0]}} 64 {name ADDR_GENERATION_CHILD1_DATA_1 type o_data sigs {generation_child1[63:32]}} 68 {name ADDR_GENERATION_CHILD2_CTRL type o_none sigs generation_child2} 72 {name ADDR_GENERATION_CHILD2_DATA_0 type o_data sigs {generation_child2[31:0]}} 76 {name ADDR_GENERATION_CHILD2_DATA_1 type o_data sigs {generation_child2[63:32]}} 80 {name ADDR_MUTATION_PROBABILITY_CTRL type i_none sigs mutation_probability} 84 {name ADDR_MUTATION_PROBABILITY_DATA_0 type i_data sigs {mutation_probability[23:0]}} 88 {name ADDR_RANDOM_CTRL type i_none sigs random} 92 {name ADDR_RANDOM_DATA_0 type i_data sigs {random[23:0]}}} include_memory 0 mem_map {} include_interrupt 0 task_handshake 1 has_ap_continue 0"
    }
    aclk {
        type "clock"
        buses "S_AXI_SLV0"
