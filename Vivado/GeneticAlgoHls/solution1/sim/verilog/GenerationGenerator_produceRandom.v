...
reg   [23:0] val_V_reg_153;
(* fsm_encoding = "none" *) reg   [2:0] ap_CS_fsm;
wire    ap_CS_fsm_state2;
wire   [31:0] tmp_fu_127_p1;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_1_fu_132_p2;
wire   [23:0] tmp_2_fu_138_p2;
reg   [2:0] ap_NS_fsm;
...
assign GenerationGenerator_randomNumberIndex_V_o = ((tmp_1_fu_132_p2[0:0] === 1'b1) ? 24'd0 : tmp_2_fu_138_p2);

assign GenerationGenerator_randomNumbers_V_address0 = tmp_fu_127_p1;

assign GenerationGenerator_randomNumbers_V_d0 = val_V_reg_153;

assign ap_CS_fsm_state2 = ap_CS_fsm[32'd1];

assign ap_CS_fsm_state3 = ap_CS_fsm[32'd2];

assign tmp_1_fu_132_p2 = ((GenerationGenerator_randomNumberIndex_V_i == 24'd23) ? 1'b1 : 1'b0);

assign tmp_2_fu_138_p2 = (GenerationGenerator_randomNumberIndex_V_i + 24'd1);

assign tmp_fu_127_p1 = GenerationGenerator_randomNumberIndex_V_i;
